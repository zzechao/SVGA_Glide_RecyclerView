...
annotationVisitor1.visit(null, "isGlide");
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "isGlide", "Z", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/opensource/svgaplayer/SVGAVideoEntity", "isGlide", "Z");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
