...
annotationVisitor1.visit(null, "mapSizeZ");
annotationVisitor1.visit(null, "recycle");
annotationVisitor1.visit(null, "");
annotationVisitor1.visit(null, "recycleImage");
annotationVisitor1.visit(null, "recycleImageZ");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_FINAL, "mapSizeZ", "()I", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_FINAL, "recycleImageZ", "()V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/svga/glide/SVGAGlideResourceDelegate", "mapSizeZ", "()I", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/svga/glide/SVGAGlideResourceDelegate", "recycleImageZ", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/svga/glide/SVGAGlideResourceDelegate", "resource", "Lcom/svga/glide/SVGAResource;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/svga/glide/SVGAResource", "getVideoItem", "()Lcom/opensource/svgaplayer/SVGAVideoEntity;", false);
methodVisitor.visitInsn(DUP);
